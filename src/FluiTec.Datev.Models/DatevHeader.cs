...
namespace FluiTec.Datev.Models
{
	...
	public class DatevHeader : IDatevRow
	{
		...
		/// <param name="exportedBy">			Describes who exported this object. </param>
		...
		public DatevHeader(string exportedBy, string isoCurrencySymbol = null)
		{
			...
			StartOfBusinessYear = new DateTime(Created.Year, month: 1, day: 1);
		...
		public IValidator<IDatevRow> GetValidator()
		{
			if (DataCategory == null)
				throw new NullReferenceException($"{nameof(DataCategory)} must not be null for this method to succeed.");
